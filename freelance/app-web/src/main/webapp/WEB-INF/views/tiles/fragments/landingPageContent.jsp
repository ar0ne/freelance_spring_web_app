    ...
    <body id="page-top" class="index">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand page-scroll" href="#page-top">Freelance Platform</a>
                </div>
        ...
        <header>
            <div class="container">
                <div class="intro-text">
                    <div class="intro-lead-in">Welcome To Our Freelance Platform!</div>
                    <div class="intro-heading">Here you can find any work for yourself!</div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="timeline">
                            ...
                            <li>
                                <div class="timeline-image">
                                    <img class="img-circle img-responsive" src="<c:url value='/resources/img/about/3.jpg'/>" alt="">
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <h4>December 2012</h4>
                            ...
                            <li class="timeline-inverted">
                                <div class="timeline-image">
                                    <img class="img-circle img-responsive" src="<c:url value='/resources/img/about/4.jpg'/>" alt="">
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <h4>July 2014</h4>
        ...
        <footer>
           <div class="container">
               <div class="row">
                   <div class="col-md-4">
                       <span class="copyright">Copyright &copy; Freelance Platform by <a href="http://github.com/ar0ne">Serj Ar[]ne</a> 2015</span>
                   </div>
                   <div class="col-md-4">
                       <ul class="list-inline social-buttons">
                           <li><a href="#"><i class="fa fa-twitter"></i></a>
